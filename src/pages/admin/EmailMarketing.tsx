  ...
  const loadData = async () => {
    try {
      const [subscribersData, campaignsData, templatesData] = await Promise.all([
        ...
        supabase.from("email_templates").select("*").eq("template_type", "newsletter")
      ]);
        ...
        <TabsContent value="campaign">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Send a newsletter to all subscribers</CardDescription>
            </CardHeader>
            ...
            <CardContent>
              <div className="space-y-4">
                {subscribers.map((subscriber: any) => (
                  <div key={subscriber.id} className="flex items-center justify-between p-4 border rounded">
                    <div>
            ...
            <CardContent>
              <div className="space-y-4">
                {campaigns.map((campaign: any) => (
                  <div key={campaign.id} className="flex items-center justify-between p-4 border rounded">
                    <div>
